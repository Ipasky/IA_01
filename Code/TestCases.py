...
class TestCases(unittest.TestCase):
    ...
    def test_depth_first_search(self):
        ...
        print("TEST DEPTH FIRST SEARCH 1 SUCCESS ROUTE: ", route1.route)
        self.assertEqual(route2, Path([13, 8, 7, 6, 5, 2, 1]))
        print("TEST DEPTH FIRST SEARCH 2 SUCCESS ROUTE: ", route2.route)
        self.assertEqual(route3, Path([5, 2, 10, 11, 12]))
        print("TEST DEPTH FIRST SEARCH 3 SUCCESS ROUTE: ", route3.route)
        self.assertEqual(route4, Path([14, 13, 8, 7, 6, 5, 2, 10]))
        print("TEST DEPTH FIRST SEARCH 4 SUCCESS ROUTE: ", route4.route)
    ...
    def test_breadth_first_search(self):
        ...
        self.assertEqual(route1, Path([2, 5, 6, 7]))
        print("TEST BREADTH FIRST SEARCH 1 SUCCESS ROUTE: ", route1.route)
        self.assertEqual(route2, Path([13, 12, 11, 10, 2, 1]))
        print("TEST BREADTH FIRST SEARCH 2 SUCCESS ROUTE: ", route2.route)
        self.assertEqual(route3, Path([5, 10, 11, 12]))
        print("TEST BREADTH FIRST SEARCH 3 SUCCESS ROUTE: ", route3.route)
        self.assertEqual(route4, Path([14, 13, 12, 11, 10]))
        print("TEST BREADTH FIRST SEARCH 4 SUCCESS ROUTE: ", route4.route)
